...
func (e *extenderPerReq) processCreate() (_ interface{}, errInfo *errcode.ErrorInfo) {
	...
	e.ginContext = audit.SetAuditInfo(c, audit.CreateConfigMap, generateCmName(cm.Name, cm.Namespace, e.cluster, string(cm.UID)), cm)
...
func (e *extenderPerReq) processUpdate() (_ interface{}, errInfo *errcode.ErrorInfo) {
	...
	c = audit.SetAuditInfo(c, audit.UpdateConfigMap, generateCmName(toUpdateCm.Name, toUpdateCm.Namespace, e.cluster, string(uid)), toUpdateCm)
...
func (e *extenderPerReq) processDelete() (_ interface{}, errInfo *errcode.ErrorInfo) {
	...
	c = audit.SetAuditInfo(c, audit.DeleteConfigMap, generateCmName(toDeleteCm.Name, toDeleteCm.Namespace, cluster, string(toDeleteCm.UID)), toDeleteCm)
