...
export INSTALLER_VERSION=v1.0
export WARDEN_IMAGE=hub.c.163.com/kubecube/warden:v1.0.3
export JWT_SECRET=56F0D8DB90241C6E
export WARDEN_INIT_IMAGE=hub.c.163.com/kubecube/warden-init:v1.0.3
